...
headers = {
        ...
        "authtoken": "8c3542e48056185e09232cdc29182e3e5478db7a2024734173",
        "pin": "560068",
        "priority": "u=1, i",
...
cookies = {
        "_ALGOLIA": "anonymous-797a8afd-8933-4fd2-9da5-d54ccd35d221",
        "new_customer": "false",
...
async def calling_rest(session, code):
    params = {"coupon_code": code, "cart_id": "649837557"}
...
async def main():
    ...
    success = set([r["code"] for r in results if r["status"] == "success" and r["code"]])
